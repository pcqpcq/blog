! function(a, b) {
    ...
    a.DLMenu = function(b, c) {
        ...
        _config: function() {
            this.open = !1, this.$trigger = this.$el.children(".dl-trigger"), this.$menu = this.$el.children("ul.dl-menu"), this.$menuitems = this.$menu.find("li:not(.dl-back)"), this.$el.find("ul.dl-submenu").prepend('<li class="dl-back"><a href="#">返回</a></li>'), this.$back = this.$menu.find("li.dl-back")
        },
